...
<li class="pub-item">
    ...
    <div class="links">
    <a class="link" href="{{ '/assets/docs/papers/belief_updates_through_dynamic_modal_logic.pdf' | relative_url }}" target="_blank" rel="noopener" aria-label="PDF: Belief Updates through Dynamic Modal Logic">PDF</a>
    </div>
</li>
<li class="pub-item">
    ...
    <div class="links">
    <a class="link" href="{{ '/assets/docs/papers/predicting_a_subjects_card_with_the_muse_S_headband.pdf' | relative_url }}" target="_blank" rel="noopener" aria-label="PDF: Predicting a Subject's Card with the Muse-S headband">PDF</a>
    </div>
</li>
</ul>
...
<li class="pub-item">
    ...
    <div class="links">
    <a class="link" href="{{ '/assets/docs/books/Mi_Esperanza__Daniel_Diaz_Quilez.pdf' | relative_url }}" target="_blank" rel="noopener" aria-label="PDF: Mi Esperanza">PDF</a>
    <a class="link" href="{{ '/assets/docs/books/Mi_Esperanza__Daniel_Diaz_Quilez.epub' | relative_url }}" target="_blank" rel="noopener" aria-label="EPUB: Mi Esperanza">EPUB</a>
    <a class="link" href="https://www.amazon.es/-/en/Mi-Esperanza-Daniel-D%C3%ADaz-Qu%C3%ADlez/dp/B0GCVS83G4/" target="_blank" rel="noopener" aria-label="Paperback: Mi Esperanza, on Amazon">Paperback</a>
    </div>
</li>
</ul>
