...
<div class="sw-card">
    ...
    <div class="links">
        <a class="link" href="https://github.com/Tempate/Funes" target="_blank" rel="noopener" aria-label="Engine's GitHub: Ataxx Engine and Server">Engine's GitHub</a>
        <a class="link" href="https://github.com/Tempate/litaxx" target="_blank" rel="noopener" aria-label="Server's GitHub: Ataxx Engine and Server">Server's GitHub</a>
    </div>
</div>
